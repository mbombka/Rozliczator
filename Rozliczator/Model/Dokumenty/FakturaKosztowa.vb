...
#Region "Properties"
    ...
    Private _Sprzedawca As String
    Public Property Sprzedawca() As String
        Get
            Return _Sprzedawca
        End Get
        ...
        Set(ByVal value As String)
            _Sprzedawca = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("Sprzedawca"))
        End Set
    End Property
    ...
    Private _DoZwrotu As Boolean
    Public Property DoZwrotu() As Boolean
        Get
            Return _DoZwrotu
        End Get
        ...
        Set(ByVal value As Boolean)
            _DoZwrotu = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("DoZwrotu"))
        End Set
    End Property

    Private _CzyjKoszt As String
    Public Property CzyjKoszt() As String
        Get
            Return _CzyjKoszt
        End Get
        ...
        Set(ByVal value As String)
            _CzyjKoszt = value
            OsobaCSEG = OsobaCSEG ' refresh visibility of some elements
            UmowyListOfOsoba = UmowyListOfOsoba
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("CzyjKoszt"))
        End Set
    End Property
